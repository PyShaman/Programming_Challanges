# Programming_Challanges
This repository is created only for fun/learn/enjoy/progress in programming skill (from the basic level)

Pro/g/ramming Challanges [Made by Anonymous in January 2015]

00  Name generator (+credentials)
01  Higher/lower, head/tails
...
19  Count words in a string (+lines, sentences, paragraphs, typos, ...)
20  Minesweeper
21  Connect four
22  BMI calculator
...
35  Benford's law
36  Currency converter (+various units, comodities, history, etc.)
...
48  Telner server (+client, netctat clone?)
49  IMP interpreter
50  Tetris
51  Conway's Game of Lige (other cell automata)
52  Web crawler
53  Text editor
54  RSS feed reader
55  RPN calculator
...
61  Credential validator (phone, email, other)
...
70  Two languages comunicating with each other (C++ & Java, Lisp & Python, etc.)
71  Triangle number calculator
72  Typing speed calculator
73  Name art in ASCII
74  Tower of Hanoi (more disks, more poles)
75  Quine
76  IRC bot
77  Brainfuck interpreter (+ optimalization, multiple targets)
78  Knight's tour
79  Chip-8 emulator
80  Geekcode generator (3.12)
81  Define, translate & rotate polygon (+other affine translations)
...
90  Flappy Bird
91  Fourier transform (fast or 'slow'; +visualization)
92  Method ringing simulator
93  Binary search (n-ray)
94  Nintendo Oil Panic
95  Sierpiński triangle
96  Dor & cross product of two vectors (exterior product)
